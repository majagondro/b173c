...
/**
  THE FOLLOWING WAS COPIED FROM <SDL2/SDL_scancode.h> AND MODIFIED besides the license obviously
  ----------------------------------------------------------------------------------------------
...
#define KEY_BACKSLASH 49 /**< Located at the lower left of the return
                                  ...
                                  */
#define KEY_NONUSHASH 50 /**< ISO USB keyboards actually use this code
...
#define KEY_GRAVE 53 /**< Located in the top left corner (on both ANSI
...
#define KEY_PAUSE 72
#define KEY_INSERT 73 /**< insert on PC help on some Mac keyboards (but
...
#define KEY_NUMLOCKCLEAR 83 /**< num lock on PC clear on Mac keyboards
                                     */
...
#define KEY_NONUSBACKSLASH 100 /**< This is the additional key that ISO
...
#define KEY_POWER 102 /**< The USB document says this is a status flag
...
#define KEY_INTERNATIONAL1 135 /**< used on Asian keyboards see
...
#define KEY_MODE 257    /**< I'm not sure if this is really not covered
...
#define KEY_DISPLAYSWITCH 277 /**< display mirroring/dual display
...
#define KEY_SOFTLEFT 287 /**< Usually situated below the display on phones and
                                      used as a multi-function feature key for selecting
                                      a software defined function shown on the bottom left
                                      of the display. */
#define KEY_SOFTRIGHT 288 /**< Usually situated below the display on phones and
                                       used as a multi-function feature key for selecting
